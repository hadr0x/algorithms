...
class testSort(unittest.TestCase):
    def test_heapSort(self):
        self.assertEqual(insertion_sort(unorderedArray), [1, 2, 4, 8, 9, 12, 19, 25, 28, 29, 30])
        self.assertEqual(insertion_sort(reversedArray), [1, 2, 5, 6, 9, 11, 14, 17, 20, 23, 27, 30])
